...
class about extends React.Component{
    ...
    componentDidMount() {
        axios.post("http://localhost:5000/users/memberinfo",{
            profession: "Sales and Related Occupations (insurance, vendors, advertising etc.)"
        })
        .then((result) =>{
        ...
        return (
            ...
            <div className="section  text-center">
                <div className="container">
                    <h2 className="title"> Sales and Related Occupations (insurance, vendors, advertising etc.)  </h2>
                    <Row>
                        <Col md="12">
