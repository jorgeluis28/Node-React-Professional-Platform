...
class about extends React.Component{
    ...
    componentDidMount() {
        axios.post("http://localhost:5000/users/memberinfo",{
            profession: "Education, training, and Library"
        })
        .then((result) =>{
	    	this.setState({ getata: result.data.result});
            this.setState({
                data: this.state.getata,
            })
        }
    )}
        ...
        return (
            ...
            <div className="section  text-center">
                <div className="container">
                    <h2 className="title">  Education, training, and Library </h2>
                    <Row>
                        <Col md="12">
