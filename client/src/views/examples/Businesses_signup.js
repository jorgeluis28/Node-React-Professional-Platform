...
class RegisterPage extends Component {
  state = {
    ...
    handleSubmit = e => {
      ...
      axios
        .post("http://localhost:5000/businesses/signup", data)
        .then(function(res){
              ...
              <Col className="ml-auto mr-auto" md="6">
                <Card className="card-register ml-auto mr-auto">
                  ...
                  <Form className="register-form" onSubmit={this.handleSubmit}>
                    <label> <span className="validate_mark"> * </span> Name </label>
                    <Input placeholder="Name" name="name" className="main_text" type="text" onChange={this.onNameChange} required/>
                    <label> <span className="validate_mark"> * </span> Industry </label>
                    <Input placeholder="Industry" name="industry" className="main_text" type="text" onChange={this.onIndustryChange} />
